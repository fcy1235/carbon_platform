package cn.iocoder.power.gateway.filter.logging;
 ...
 * 网关的访问日志过滤器
 *
 * 从功能上，它类似 power-spring-boot-starter-web 的 ApiAccessLogFilter 过滤器
 *
...
public class AccessLogFilter implements GlobalFilter, Ordered {
    ...
    public Mono<Void> filter(ServerWebExchange exchange, GatewayFilterChain chain) {
        ...
        log.info("[filter][uri({} {}) 请求进入网关][IP: {}]", request.getURI(), request.getMethod(), gatewayLog.getUserIp());
