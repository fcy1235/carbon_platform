package cn.iocoder.power.gateway.util;

import cn.hutool.core.map.MapUtil;
import cn.iocoder.power.framework.common.util.json.JsonUtils;
import cn.iocoder.power.gateway.filter.security.LoginUser;
 ...
 * 安全服务工具类
 *
 * copy from power-spring-boot-starter-security 的 SecurityFrameworkUtils 类
 *
 * 
 */
@Slf4j
