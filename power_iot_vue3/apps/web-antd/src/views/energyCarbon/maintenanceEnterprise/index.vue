...
import {
  getMaintenanceEnterprisePage,
  deleteMaintenanceEnterprise,
...
const toolbarActions = [
  {
    ...
    auth: ['carbon:maintenance-enterprise:create'],
  ...
  },
  {
    ...
    auth: ['carbon:maintenance-enterprise:export'],
  ...
  return [
    {
      ...
      auth: ['carbon:maintenance-enterprise:query'],
    ...
    },
    {
      ...
      auth: ['carbon:maintenance-enterprise:update'],
    ...
    },
    {
      ...
      auth: ['carbon:maintenance-enterprise:delete'],
      popConfirm: {
        title: '确定要删除该维保企业吗？删除后数据不可恢复，请谨慎操作！',
...
async function handleDelete(row: any) {
  ...
  try {
    await deleteMaintenanceEnterprise(row.id);
...
function handleExport() {
  ...
  if (formValues.division?.[2]) queryParams.countyCode = formValues.division[2];
  if (formValues.enterpriseName) queryParams.enterpriseName = formValues.enterpriseName;
  if (formValues.unifiedSocialCreditCode) queryParams.unifiedSocialCreditCode = formValues.unifiedSocialCreditCode;
      ...
      ajax: {
        query: async (
          ...
          const params: MaintenanceEnterprisePageParam = {
            ...
            countyCode: formValues.division?.[2],
            enterpriseName: formValues.enterpriseName,
            unifiedSocialCreditCode: formValues.unifiedSocialCreditCode,
          };
