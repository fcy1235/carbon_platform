...
import { deleteFactorLib, getFactorLibPage } from '#/api/energyCarbon/factorLib';
...
function getRowActions(row: any) {
  return [
    ...
    },
    {
      ...
      auth: ['carbon:factor-lib:delete'],
      popConfirm: {
        title: '确定要删除该排放因子吗？删除后数据不可恢复，请谨慎操作！',
      ...
      ajax: {
        query: async (
          ...
          const params: FactorLibPageParam = {
            ...
            factorName: formValues.factorName,
            emissionSource: formValues.emissionSource,
          };
