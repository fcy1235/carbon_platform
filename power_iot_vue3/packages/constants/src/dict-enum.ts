...
const SYSTEM_DICT = {
  ...
  SYSTEM_USER_EDUCATION: 'system_user_education',
...
/** ========== ENERGY_CBON - 能碳管理模块 ========== */
const ENERGY_CBON_DICT = {
  ENERGY_CBON_DATA_SOURCE: 'carbon_data_source', // 能碳管理数据来源
  ENERGY_CBON_TRANSFORMATION_TYPE: 'carbon_transformation_type', // 能碳管理数据转换类型
  ENERGY_CBON_ELECTRIC_SOURCE: 'carbon_electric_source', // 能碳电力数据来源
  ENERGY_CBON_GAS_SOURCE: 'carbon_gas_source', // 能碳燃气数据来源
  ENERGY_CBON_CLIMATE_ZONE: 'carbon_climate_zone', // 能碳所属气候区域
  ENERGY_CBON_EMISSION_SCOPE: 'carbon_emission_scope', // 能碳排放源范围
  ENERGY_CBON_GAS_CATEGORY: 'carbon_gas_category', // 能碳气体类别
  ENERGY_CBON_DEVICE_TYPE: 'carbon_device_type', // 能碳设备类型
  ENERGY_CBON_DEVICE_STATUS: 'carbon_device_status', // 能碳设备状态
  ENERGY_CBON_ACTIVITY_TYPE: 'carbon_activity_type', // 能碳核算活动名称
  ENERGY_CBON_PROJECT_STATUS: 'carbon_project_status', // 项目管理状态
  ENERGY_CBON_REFORM_MODE: 'carbon_transformation_mode', // 能碳改造类型
  ENERGY_CBON_REFORM_BATCH: 'carbon_transformation_batch', // 能碳改造批次
  ENERGY_CBON_SUBSIDY_METHOD: 'carbon_subsidy_method', // 能碳发放补贴方式
  ENERGY_CBON_HOUSE_USAGE: 'carbon_house_usage', // 能碳房屋用途
  ENERGY_CBON_USER_CATEGORY: 'carbon_user_category', // 能碳用户分类
  ENERGY_CBON_USE_STATUS: 'carbon_use_status', // 能碳用户使用状态
  ENERGY_CBON_GAS_METER_TYPE: 'carbon_gas_meter_type', // 能碳燃气表类型
  ENERGY_CBON_SAFE_DEVICE_STATUS: 'carbon_safe_device_status', // 能碳安全装置配备情况
  ENERGY_CBON_SERVICE_STATUS: 'carbon_service_status', // 服务状态
  ENERGY_CBON_NETWORK_BUSINESS_STATUS: 'carbon_network_business_status', // 网点经营状态
  ENERGY_CBON_BON_ENTERPRISE_TYPE: 'carbon_enterprise_type', // 入职培训企业类型
  ENERGY_CBON_UNIT_MEASURE: 'carbon_unit_measure', // 能碳计量单位
  ENERGY_CBON_LEDGER_TYPE: 'carbon_ledger_type', // 台账类型
  ENERGY_CBON_LEDGER_REPORT_STATUS: 'carbon_ledger_report', // 台账上报流程状态
  ENERGY_CBON_SUCCESS_STATUS: 'carbon_success_status', // 台账文件上传状态
  ENERGY_CBON_LEDGER_IMPORT_STATUS: 'carbon_ledger_import_status', // 台账导入任务状态
} as const;
