package cn.iocoder.power.module.iot.gateway.protocol.udp.handler.upstream;
...
import cn.iocoder.power.module.iot.gateway.protocol.udp.manager.IotUdpSessionManager;
import cn.iocoder.power.module.iot.gateway.serialize.IotMessageSerializer;
import cn.iocoder.power.module.iot.gateway.service.auth.IotDeviceTokenService;
...
import static cn.iocoder.power.module.iot.gateway.enums.ErrorCodeConstants.DEVICE_AUTH_FAIL;
...
public class IotUdpUpstreamHandler {
    ...
    private void registerSession(InetSocketAddress address, IotDeviceRespDTO device, String clientId) {
        ...
        sessionInfo.setDeviceId(device.getId());
        sessionInfo.setProductKey(device.getProductKey());
        sessionInfo.setDeviceName(device.getDeviceName());
        sessionInfo.setAddress(address);
