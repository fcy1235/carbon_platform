package cn.iocoder.power.module.system.service.social;
...
import cn.iocoder.power.framework.common.util.cache.CacheUtils;
import cn.iocoder.power.framework.common.util.http.HttpUtils;
import cn.iocoder.power.framework.common.util.object.BeanUtils;
import cn.iocoder.power.module.system.api.social.dto.SocialWxQrcodeReqDTO;
import cn.iocoder.power.module.system.api.social.dto.SocialWxaOrderNotifyConfirmReceiveReqDTO;
import cn.iocoder.power.module.system.api.social.dto.SocialWxaOrderUploadShippingInfoReqDTO;
import cn.iocoder.power.module.system.api.social.dto.SocialWxaSubscribeMessageSendReqDTO;
import cn.iocoder.power.module.system.controller.admin.socail.vo.client.SocialClientPageReqVO;
import cn.iocoder.power.module.system.controller.admin.socail.vo.client.SocialClientSaveReqVO;
import cn.iocoder.power.module.system.dal.dataobject.social.SocialClientDO;
import cn.iocoder.power.module.system.dal.mysql.social.SocialClientMapper;
import cn.iocoder.power.module.system.dal.redis.RedisKeyConstants;
import cn.iocoder.power.module.system.enums.social.SocialTypeEnum;
import cn.iocoder.power.module.system.framework.justauth.core.AuthRequestFactory;
...
import static cn.iocoder.power.framework.common.util.collection.MapUtils.findAndThen;
import static cn.iocoder.power.framework.common.util.date.LocalDateTimeUtils.UTC_MS_WITH_XXX_OFFSET_FORMATTER;
import static cn.iocoder.power.framework.common.util.date.LocalDateTimeUtils.toEpochSecond;
import static cn.iocoder.power.framework.common.util.json.JsonUtils.toJsonString;
...
public class SocialClientServiceImpl implements SocialClientService {
     ...
     * 3. developer：开发版
     */
    @Value("${power.wxa-code.env-version:release}")
     ...
     * 3. formal：正式版
     */
    @Value("${power.wxa-subscribe-message.miniprogram-state:formal}")
    ...
    public void uploadWxaOrderShippingInfo(Integer userType, SocialWxaOrderUploadShippingInfoReqDTO reqDTO) {
        ...
        // 对应 ISSUE：https://gitee.com/zhijiantianya/power-cloud/pulls/230
