package cn.iocoder.power.module.system.enums;
...
public interface ErrorCodeConstants {
    ...
    // ========== 行政区 1-002-029-000 ==========
    ErrorCode AREA_NAME_DUPLICATE = new ErrorCode(1_002_029_000, "已经存在该名字的行政区");
    ErrorCode AREA_PARENT_NOT_EXITS = new ErrorCode(1_002_029_001, "父级行政区不存在");
    ErrorCode AREA_NOT_FOUND = new ErrorCode(1_002_029_002, "当前行政区不存在");
    ErrorCode AREA_EXITS_CHILDREN = new ErrorCode(1_002_029_003, "存在子行政区，无法删除");
    ErrorCode AREA_PARENT_ERROR = new ErrorCode(1_002_029_004, "不能设置自己为父行政区");
    ErrorCode AREA_PARENT_IS_CHILD = new ErrorCode(1_002_029_005, "不能设置自己的子行政区为父行政区");
