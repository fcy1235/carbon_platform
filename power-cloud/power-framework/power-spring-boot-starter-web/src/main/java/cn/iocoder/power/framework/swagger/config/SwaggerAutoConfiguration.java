package cn.iocoder.power.framework.swagger.config;
 ...
 * 
 */
@AutoConfiguration(before = Knife4jAutoConfiguration.class) // before 原因，保证覆写的 Knife4jOpenApiCustomizer 先生效！相关
...
public class SwaggerAutoConfiguration {
     ...
     *
     * app-api 前缀不生效，都是使用 admin-api</a>
     */
