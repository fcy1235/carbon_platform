package cn.iocoder.power.framework.web.config;
...
import cn.iocoder.power.framework.web.core.filter.CacheRequestBodyFilter;
import cn.iocoder.power.framework.web.core.handler.GlobalExceptionHandler;
import cn.iocoder.power.framework.web.core.handler.GlobalResponseBodyHandler;
...
public class WebAutoConfiguration {
    ...
    @ConditionalOnProperty(prefix = "power.web.cors", name = "enable", havingValue = "true", matchIfMissing = true)
