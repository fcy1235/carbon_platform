package cn.iocoder.power.framework.common.biz.system.oauth2;
...
@FeignClient(name = RpcConstants.SYSTEM_NAME) // TODO fallbackFactory =
...
public interface OAuth2TokenCommonApi {
    ...
    @Parameters({
        ...
        @Parameter(name = "clientId", description = "客户端编号", required = true, example = "123456")
    })
