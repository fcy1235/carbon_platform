package cn.iocoder.power.framework.mybatis.config;

import cn.hutool.core.collection.CollUtil;
import cn.hutool.core.util.StrUtil;
import cn.iocoder.power.framework.common.util.json.JsonUtils;
import cn.iocoder.power.framework.mybatis.core.handler.DefaultDBFieldHandler;
...
@MapperScan(value = "${power.info.base-package}", annotationClass = Mapper.class,
