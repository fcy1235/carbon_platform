package cn.iocoder.power.module.infra.controller.admin.codegen;
...
import cn.iocoder.power.module.infra.controller.admin.codegen.vo.CodegenDetailRespVO;
import cn.iocoder.power.module.infra.controller.admin.codegen.vo.CodegenPreviewRespVO;
...
import cn.iocoder.power.module.infra.controller.admin.codegen.vo.table.CodegenTableRespVO;
import cn.iocoder.power.module.infra.controller.admin.codegen.vo.table.DatabaseTableRespVO;
import cn.iocoder.power.module.infra.convert.codegen.CodegenConvert;
...
import cn.iocoder.power.module.infra.service.codegen.CodegenService;
...
import static cn.iocoder.power.framework.security.core.util.SecurityFrameworkUtils.getLoginUserNickname;
import static cn.iocoder.power.module.infra.framework.file.core.utils.FileTypeUtils.writeAttachment;
...
public class CodegenController {
    ...
    @Parameters({
            ...
            @Parameter(name = "name", description = "表名，模糊匹配", example = "root"),
            @Parameter(name = "comment", description = "描述，模糊匹配", example = "root")
    })
