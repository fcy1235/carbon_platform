package cn.iocoder.power.module.infra.controller.admin.config.vo;
...
import cn.iocoder.power.module.infra.enums.DictTypeConstants;
...
public class ConfigRespVO {
    ...
    @Schema(description = "参数键名", requiredMode = Schema.RequiredMode.REQUIRED, example = "power.db.username")
    @ExcelProperty("参数键名")
    private String key;
